...
| <a name="input_cluster_autoscaler_helm_chart_version"></a> [cluster\_autoscaler\_helm\_chart\_version](#input\_cluster\_autoscaler\_helm\_chart\_version) | Cluster autoscaler helm chart version | `string` | `"9.29.3"` | no |
| <a name="input_cluster_autoscaler_image_tag"></a> [cluster\_autoscaler\_image\_tag](#input\_cluster\_autoscaler\_image\_tag) | Cluster autoscaler image tag | `string` | `"v1.27.2"` | no |
...
| <a name="input_cluster_autoscaler_verbosity_level"></a> [cluster\_autoscaler\_verbosity\_level](#input\_cluster\_autoscaler\_verbosity\_level) | Verbosity level | `string` | `"4"` | no |
...
| <a name="input_eks_cluster_version"></a> [eks\_cluster\_version](#input\_eks\_cluster\_version) | Kubernetes version to use for the EKS cluster | `string` | `"1.27"` | no |
