...
| <a name="input_ec_subnet_single_az"></a> [ec\_subnet\_single\_az](#input\_ec\_subnet\_single\_az) | Whether to Elastic cache subnet group with single subnet | `bool` | `false` | no |
...
| <a name="input_eks_cluster_version"></a> [eks\_cluster\_version](#input\_eks\_cluster\_version) | Kubernetes version to use for the EKS cluster | `string` | `"1.23"` | no |
...
| <a name="input_eks_db_root_volume_size"></a> [eks\_db\_root\_volume\_size](#input\_eks\_db\_root\_volume\_size) | The size of the volume in gigabytes | `number` | `100` | no |
