...
locals {
  ...
  vpc_endpoint_service_name = var.vpc_custom_service_name != "" && vpc_endpoint_service_exists ? var.vpc_custom_service_name : local.vpc_endpoint_service_name_map[var.region]
