...
locals {
  ...
  vpc_endpoint_service_name_temp  = vpc_endpoint_service_exists ? local.vpc_endpoint_service_name_map[var.region] : "dummy_endpoint_will_not_be_used"
  vpc_endpoint_service_name = var.vpc_custom_service_name != "" && vpc_endpoint_service_exists ? var.vpc_custom_service_name : vpc_endpoint_service_name_temp
