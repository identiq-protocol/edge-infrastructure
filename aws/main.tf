...
internal_domain_value = ${var.internal_domain_name != "NOT_SET" ? aws_acm_certificate.int-cert[0].arn : "NOT_SET"}
...
internal_domain_value = ${var.external_domain_name != "NOT_SET" ? aws_acm_certificate.ext-cert[0].arn : "NOT_SET"}
EOF
}
output connect {
